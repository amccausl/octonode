...
(function() {
  var Client, Gist, Me, Org, Pr, Repo, Search, Team, User, querystring, request,
  ...
  Client = (function() {
    ...
    Client.prototype.query = function(path, page, per_page, params) {
      var key, query_params, uri, value;
      if (path == null) {
        path = '/';
      }
      if (page == null) {
      ...
      if (typeof this.token === 'string') {
        ...
        query_params['client_id'] = this.token.id;
        query_params['client_secret'] = this.token.secret;
      }
      if (page != null) {
